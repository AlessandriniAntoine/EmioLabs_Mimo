...
![](assets/data/images/labMimo-setup-emio.png){width=75% .center}
:::
...
|  ![](assets/data/images/labMimo-openloop-structure.png)   |
|:------------------------------------------------:|
...
#runsofa-button("assets/labs/EmioLabs_Mimo/scripts/reduction.py" "--mode" "1" "--order" "order")
:::::
::::::
